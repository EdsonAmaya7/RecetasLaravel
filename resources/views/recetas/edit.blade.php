...
@section('content')
<h2 class="text-center mb-5">Actualizar receta</h2>

<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <form action="{{ route('recetas.update',$receta->id) }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                <input type="submit" name="" id="" value="Actualizar Receta" class="btn btn-primary mt-4">
            </div>
        </form>
    </div>
</div>
